...
def imprimir_resultados(rotas_finais, tarefas, matriz_distancias, depot_node, optimal_value=None, custo_melhorado=False):
...
tarefas = extrair_tarefas(required_edges, required_arcs, required_vertices)
imprimir_resultados(rotas_finais, tarefas, matriz_distancias, depot_node, optimal_value)
rotas_melhoradas = melhoria_swap_entre_rotas(rotas_finais, tarefas, matriz_distancias, capacity, depot_node)
imprimir_resultados(rotas_melhoradas, tarefas, matriz_distancias, depot_node, optimal_value, custo_melhorado=True)
